...
\begin{homeworkProblem}
	\begin{enumerate}[a.]
		%% Problem 4-a.
		\item
		Let $w = (w_1, w_2)'$ denote weight amounts of investment in risky asset. Then Sharpe ratio of a portfolio including these assets can be represented as $\frac{\overline{R}_p - R_f}{\sqrt{w'Vw}}$, where $\overline{R}_p = w'\overline{R} + (1-w'e)R_f$, $e = (1, 1)'$. Therefore, if there is a target portfolio return $\overline{R}_p$, the maximization problem can be stated as equation (\ref{eq: prob4-a: max problem}), and it is equivalent to minimization problem (\ref{eq: prob4-a: min problem}).
%----------------------------------------------------------------------------------------
		%% Maximization Problem 4.a-1
		\begin{equation}	\label{eq: prob4-a: max problem}
		\begin{aligned}
			& \max_w \frac{\overline{R}_p - R_f}{\sqrt{w'Vw}}	\\
			& \text{subject to } \overline{R}_p = w'\overline{R} + (1-w'e)R_f
		\end{aligned}
		\end{equation}
%----------------------------------------------------------------------------------------
		%% Minimization Problem 4.a-1
		\begin{equation}	\label{eq: prob4-a: min problem}
		\begin{aligned}
			& \min_w \frac{\sqrt{w'Vw}}{\overline{R}_p - R_f}	\\
			& \text{subject to } \overline{R}_p = w'\overline{R} + (1 - w'e)R_f
		\end{aligned}
		\end{equation}
		%% Problem 4-b.
