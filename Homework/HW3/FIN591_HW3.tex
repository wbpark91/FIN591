...
\begin{homeworkProblem}
    \begin{enumerate}[a.]
        ...
        \begin{equation}
            ...
            + (\gamma - 1) (\alpha + \frac{1}{2} \delta^2) (s - t)}
        ...
        \begin{equation}
            \begin{aligned}
                ...
                + (1 - \gamma)(\alpha + \frac{1}{2} \delta^2)
...
\begin{homeworkProblem}
    \begin{enumerate}[a.]
        ...
        \begin{equation}
            \begin{aligned}
                dW  &= \omega \frac{dS}{S} + (1 - \omega) rdt - Cdt   \\
                    &= (\omega(\mu - \lambda k - r)W + rW - C)dt + \sigma W dZ
                        + \omega(Y - 1)Wdq
            \end{aligned}
            \label{eq:prob2-a}
        \end{equation}
        ...
        $dW = (\omega(\mu - \lambda k - r)W + rW)dt + \sigma W dZ
            + \omega(Y - 1)Wdq$.
        Let $J(W, s) = \max_{C, \omega} \E_s[\int_0^T e^{-\phi t}u(C_t)dt]$. Then the
        following equation follows.
        \begin{equation}
            \begin{aligned}
                J(W, 0) &= \max_{C, \omega} \E_0 \left[ \int_0^{\Delta t} e^{-\phi t}u(C_t)dt
                                    + J(W, \Delta t) \right]    \\
                        &= \max_{C, \omega} \E_0 [ u(C_0)\Delta t
                        + J(W, 0) + J_W(\omega(\mu - \lambda k - r)W + rW - C)\Delta t  \\
                        &+ \frac{1}{2} \omega^2 \sigma^2 J_{WW}\Delta t
                        + (J(\omega(Y - 1)W, 0) - J(W, 0))dq ]
            \end{aligned}
            \label{eq:prob2-b-1}
        \end{equation}
        Letting $\Delta t \to 0$, equation (\ref{eq:prob2-b-1}) becomes
        equation (\ref{eq:prob2-b-2}), and it is Bellman equation.
        \begin{equation}
            \begin{aligned}
                0 = \max_{C, \omega} [u(c_0) + J_W(\omega(\mu - \lambda k - r)W + rW - C)
                 + \frac{1}{2} \omega^2 \sigma^2 J_{WW} + \lambda(\E[J(\omega(Y - 1)W, 0)] - J(W, 0))]
            \end{aligned}
            \label{eq:prob2-b-2}
        \end{equation}
        \item   %% c.
        ...
        \begin{equation}
            \begin{aligned}
                u_c     = J_W  \\
                J_W(\mu - \lambda k - r)W + \omega \sigma^2 J_{WW} +
                \frac{\partial}{\partial \omega}(\lambda(\E[J(\omega(Y - 1)W, 0)] - J(W, 0))]) = 0
            \end{aligned}
            \label{eq:prob2-c}
        \end{equation}
    \end{enumerate}
